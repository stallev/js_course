...
Навигация по всем темам курса. Разделы 1–8 — базовый JavaScript (несколько тем в одном файле). Разделы 9–13 — React (каждая тема в отдельном файле).
...
## Приоритеты изучения (разделы 9–13)

| Приоритет | Темы |
|-----------|------|
| 🔴 Обязательно | 29, 30, 31, 32, 33, 35, 36, 37 |
| 🟡 Ожидается | 34, 41, 42, 43 |
| 🟢 Бонус | 38, 39, 40 |

Полная сводная таблица приоритетов по всем 43 темам — [`general/02_topic_list.md`](../general/02_topic_list.md).
