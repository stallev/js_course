...
Команды из корня репозитория: префикс `middle/sandbox/`.
 ...
 *
 * Терминал: npx tsx middle/sandbox/js_sandbox/topics/topic_N/exercises.ts
 ...
 *
 * Запуск: npx tsx middle/sandbox/js_sandbox/topics/topic_N/solutions.ts
 */
...
За основу бери `middle/sandbox/js_sandbox/topics/topic_1/browser/index.html`.
...
npx tsx middle/sandbox/js_sandbox/topics/topic_N/exercises.ts

# Запуск всех решений
npx tsx middle/sandbox/js_sandbox/topics/topic_N/solutions.ts
...
```
middle/sandbox/js_sandbox/topics/topic_2/
├── exercises.ts
├── solutions.ts
└── browser/
    └── index.html

middle/sandbox/next_sandbox/lessons/topic_2/
├── exercises.ts
└── solutions.tsx
```
...
```
middle/sandbox/js_sandbox/topics/topic_15/
├── exercises.ts
├── solutions.ts
└── browser/
    └── index.html

middle/sandbox/next_sandbox/lessons/topic_15/
├── exercises.ts
└── solutions.tsx
```
