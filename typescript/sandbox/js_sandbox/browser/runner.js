/**
 * Кнопки [data-fn] вызывают export из скомпилированного exercises.js.
 * Сначала npm run bridge:watch (tsc).
 */
    ...
    btn.addEventListener("click", async () => {
      ...
      if (typeof fn !== "function") {
        outputEl.textContent =
          "Нет export function " +
          fnName +
          " в exercises.js. Запусти npm run bridge:watch и заполни exercises.ts.";
